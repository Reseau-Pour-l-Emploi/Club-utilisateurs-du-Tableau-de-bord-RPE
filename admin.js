...
function injectAdminBar(){
  ...
  bar.innerHTML=`<strong>🔐 Mode administrateur</strong>
    ...
    <button class="btn btn-sm" onclick="adminLogout()" style="margin-left:auto;background:rgba(255,255,255,.15);border:1px solid rgba(255,255,255,.3);color:#fff;">Déconnexion</button>`;
...
function injectModal(){
  ...
  d.addEventListener('click',e=>{if(e.target===d)closeAdmModal();});
}
function closeAdmModal(){const b=document.getElementById('adm-modal-bg');if(b)b.classList.remove('open');}

/* ── FIELD SCHEMAS ────────────────────────────── */
const SCHEMAS={
  actualites:{label:'une actualité',fields:[
    {k:'date',l:'Date',t:'date',req:true,span:1},
    {k:'tag',l:'Étiquette',t:'text',ph:'ex : Livraison 3.2',span:1},
  ...
  alertes:{label:'une alerte',fields:[
    {k:'type',l:'Type',t:'select',opts:[{v:'warn',l:'⚠️ Planifiée'},{v:'info',l:'ℹ️ Information'},{v:'ok',l:'✅ Résolue'}],span:1},
    {k:'title',l:'Titre',t:'text',req:true,span:2},
    {k:'desc',l:'Description',t:'textarea',span:2},
  ]},
  evenements:{label:'un événement',fields:[
    {k:'fullDate',l:'Date',t:'date',req:true,span:1},
    {k:'title',l:'Titre',t:'text',req:true,span:2},
    {k:'type',l:'Type',t:'select',opts:[{v:'embarquement',l:'🎓 Embarquement'},{v:'evolution',l:'🔭 Évolutions'},{v:'atelier',l:'🛠️ Atelier'}],span:1},
    {k:'time',l:'Heure',t:'text',ph:'10h00',span:1},
    {k:'duration',l:'Durée',t:'text',ph:'1h30',span:1},
    {k:'platform',l:'Plateforme',t:'text',ph:'Zoom / Teams',span:1},
    {k:'capacity',l:'Places / Participants',t:'text',ph:'15 places',span:1},
    {k:'desc',l:'Description',t:'textarea',span:2},
    {k:'archived',l:'Événement archivé (passé)',t:'checkbox',span:2},
    {k:'replayUrl',l:'URL replay',t:'url',ph:'https://…',span:1},
    {k:'supportUrl',l:'URL support (PPTX)',t:'url',ph:'https://…',span:1},
    {k:'crUrl',l:'URL compte rendu',t:'url',ph:'https://…',span:1},
  ]},
  livraisons:{label:'une livraison',fields:[
    {k:'day',l:'Jour',t:'text',ph:'14',req:true,span:1},
    {k:'mon',l:'Mois Année',t:'text',ph:'Mai 25',req:true,span:1},
    {k:'title',l:'Titre',t:'text',req:true,span:2},
    {k:'badge',l:'Étiquette (optionnelle)',t:'text',ph:'Dernière livraison',span:1},
    {k:'badgeType',l:'Couleur',t:'select',opts:[{v:'',l:'Aucune'},{v:'badge-teal',l:'Vert'},{v:'badge-navy',l:'Bleu'},{v:'badge-amber',l:'Ambre'}],span:1},
    {k:'desc',l:'Description',t:'textarea',span:2},
    {k:'noteUrl',l:'URL note de livraison',t:'url',ph:'https://…',span:1},
    {k:'supportUrl',l:'URL support présentation',t:'url',ph:'https://…',span:1},
    {k:'replayUrl',l:'URL replay webinaire',t:'url',ph:'https://…',span:1},
  ]},
  supports:{label:'un support',fields:[
    {k:'title',l:'Titre',t:'text',req:true,span:2},
    {k:'desc',l:'Description courte',t:'text',ph:'ex : 42 slides · mai 2025',span:2},
    {k:'fileType',l:'Type',t:'select',opts:[{v:'PPTX',l:'PowerPoint (PPTX)'},{v:'PDF',l:'PDF'},{v:'XLSX',l:'Excel (XLSX)'},{v:'Figma',l:'Figma'},{v:'Vidéo',l:'Vidéo'}],span:1},
    {k:'url',l:'URL téléchargement / visionnage',t:'url',ph:'https://…',span:1},
  ]},
  guides:{label:'un guide',fields:[
    {k:'title',l:'Titre',t:'text',req:true,span:2},
    {k:'desc',l:'Description',t:'text',ph:'ex : 8 pages · PDF',span:2},
    {k:'fileType',l:'Type',t:'select',opts:[{v:'PDF',l:'PDF'},{v:'Vidéo',l:'Vidéo'},{v:'PPTX',l:'PowerPoint'},{v:'XLSX',l:'Excel'}],span:1},
    {k:'url',l:'URL',t:'url',ph:'https://…',span:1},
  ]},
  exercices:{label:'un exercice',fields:[
    {k:'title',l:'Titre',t:'text',req:true,span:2},
    {k:'desc',l:'Description',t:'text',span:2},
    {k:'level',l:'Niveau',t:'select',opts:[{v:'Débutant',l:'Débutant'},{v:'Intermédiaire',l:'Intermédiaire'},{v:'Avancé',l:'Avancé'}],span:1},
    {k:'levelClass',l:'Couleur badge',t:'select',opts:[{v:'badge-green',l:'Vert'},{v:'badge-amber',l:'Ambre'},{v:'badge-red',l:'Rouge'}],span:1},
    {k:'url',l:'URL principal',t:'url',ph:'https://…',span:1},
    {k:'url2',l:'URL corrigé (optionnel)',t:'url',ph:'https://…',span:1},
  ]},
  glossaire:{label:'un terme',fields:[
    {k:'t',l:'Terme',t:'text',req:true,span:2},
    {k:'c',l:'Catégorie',t:'select',opts:[{v:'mesure',l:'Mesure / Indicateur'},{v:'dimension',l:'Dimension / Variable'}],span:1},
    {k:'d',l:'Définition',t:'textarea',req:true,span:2},
    {k:'e',l:'Exemple / précision',t:'textarea',span:2},
  ]},
  ressources:{label:'une ressource',fields:[
    {k:'name',l:'Nom du site',t:'text',req:true,span:2},
    {k:'cat',l:'Catégorie',t:'text',req:true,ph:'ex : Statistiques emploi & marché du travail',span:2},
    {k:'icon',l:'Icône (emoji)',t:'text',ph:'📊',span:1},
    {k:'desc',l:'Description',t:'textarea',span:2},
    {k:'url',l:'URL',t:'url',req:true,ph:'https://…',span:1},
  ]},
  newsletters:{label:'une newsletter',fields:[
    {k:'num',l:'Numéro',t:'text',req:true,ph:'#09',span:1},
    {k:'period',l:'Période',t:'text',req:true,ph:'Juin 2025',span:1},
    {k:'title',l:'Titre',t:'text',req:true,span:2},
    {k:'desc',l:'Description',t:'textarea',span:2},
    {k:'url',l:'URL téléchargement',t:'url',ph:'https://…',span:1},
    {k:'latest',l:'Marquer comme dernière newsletter',t:'checkbox',span:2},
  ]},
};

/* ── OPEN MODAL ───────────────────────────────── */
function openAdmModal(sectionName,existingItem){
  ...
  body.innerHTML='<div class="adm-form-grid">'+schema.fields.map(f=>{
    ...
    if(f.t==='textarea')return`<div class="${cls}"><label>${f.l}${f.req?' *':''}</label>
      <textarea data-key="${f.k}" class="fc" rows="3" placeholder="${f.ph||''}">${e(val)}</textarea></div>`;
    if(f.t==='select')return`<div class="${cls}"><label>${f.l}</label>
      <select data-key="${f.k}" class="fc">${f.opts.map(o=>`<option value="${o.v}"${String(val)===String(o.v)?' selected':''}>${o.l}</option>`).join('')}</select></div>`;
    return`<div class="${cls}"><label>${f.l}${f.req?' *':''}</label>
      <input type="${f.t==='url'?'url':f.t==='date'?'date':'text'}" data-key="${f.k}" class="fc" value="${e(val)}" placeholder="${f.ph||''}"/></div>`;
  }).join('')+'</div>';
...
function openLoginModal(){
  const d=document.createElement('div');
  d.id='login-modal-bg';
  d.style.cssText='position:fixed;inset:0;background:rgba(0,0,0,.45);z-index:800;display:flex;align-items:center;justify-content:center;';
  d.innerHTML=`<div style="background:#fff;border-radius:10px;padding:1.75rem;width:min(360px,90vw);box-shadow:0 8px 32px rgba(0,0,0,.2);">
    ...
    <input type="password" id="login-pw" class="fc" placeholder="••••••••" onkeydown="if(event.key==='Enter')_doLogin()"/></div>
...
function admCtrl(sec,id){
  ...
  return`<div class="adm-ctrl">
    <button class="adm-btn" title="Modifier" onclick="openAdmModal('${sec}',DB.section('${sec}').find(x=>String(x.id)==='${id}'))">✏️ Modifier</button>
    <button class="adm-btn del" title="Supprimer" onclick="if(confirm('Supprimer cet élément ?')){DB.remove('${sec}','${id}');_refreshPage();}">🗑️ Supprimer</button>
  </div>`;
}
